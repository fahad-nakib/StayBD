...
import { useAuthStore } from "../../store/useAuthStore"; // ✅ Switched to Zustand
...
export default function LoginPage() {
  ...
  const handleEmailLogin = async (e) => {
    ...
    try {
      ...
      // 3. Sync with MongoDB and Check Ban Status
      ...
      <div className="relative w-full max-w-md z-10 animate-fade-in">
        ...
        <div className="text-center mb-8 mt-9">
          ...
          <p className="text-gray-500 text-sm mt-1">
            Bangladesh's #1 Rental Marketplace
          </p>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-xl p-8 rounded-3xl shadow-card-hover border border-white/60">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-11 py-3.5 bg-gray-50/70 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none transition-all duration-200 text-gray-800 placeholder:text-gray-400"
          ...
          <div className="relative my-7">
            ...
            <div className="relative flex justify-center">
              <span className="bg-white/80 px-4 text-sm text-gray-400 backdrop-blur-sm">
                or continue with
              </span>
            </div>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-white border border-gray-200 text-gray-700 font-semibold py-3.5 rounded-xl hover:bg-gray-50 transition-all duration-200 flex items-center justify-center gap-3 active:scale-[0.99] disabled:opacity-70 disabled:cursor-not-allowed"
          >
